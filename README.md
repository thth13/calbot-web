...
Эти же настройки используются для сообщений из формы поддержки в Telegram mini app.
В уведомление добавляются имя пользователя, username, Telegram ID и страница, с которой
было отправлено обращение.
